...
<div class="row">
		<div class ="col-sm-6">
		<legend><b>PENDING RESERVATIONS</b></legend>
  ...
  <table class="table table-hover">
    ...
    <tbody>
    <% 
    	//ReservationViewer reservation = (ReservationViewer)session.getAttribute("pending").;
		//for (int ctr=0;ctr < blabla.length;ctr++) {
		//out.println(reservation.getDestination());
		...
		//}
		//ResultSet pending = (ResultSet) session.getAttribute("pending");
	...
	%>
      ...
      <tr>
        ...
        <td align="center">
			<a href="viewreservationservlet.html?id=<%=pending.get(ctr).getReservationID()%>" class="btn btn-primary" role="button">View</a>
			</td>
      </tr>
