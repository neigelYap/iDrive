		...
		<form action="adddriver.html" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label for="department">Employee I.D.</label>
					<input type="text" id="employeeID" class="form-control" name="employeeID" placeholder="Employee I.D." required="required" maxlength="6"/>
			</div>
			
			<div class="form-group">
				<label for="licenseID">Driver's License No.</label>
					<input type="text" id="licenseID" class="form-control" name="licenseID" placeholder= "License No." required="required" maxlength="11"/>
			</div>
			
			<div class="form-group">
				<label for="licenseRestriction">Restrictions</label>
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<input type="checkbox" name="licenseRestriction" value="1"> Motorcycles/Motorized Tricycle
						</div>
						<div class="form-group">
							<input type="checkbox" name="licenseRestriction" value="2"> Vehicles up to 4500 KGs (Gross Vehicle Weight)
						</div>
						<div class="form-group">
							<input type="checkbox" name="licenseRestriction" value="3"> Vehicles above 4500 KGs (Gross Vehicle Weight)<br>
						</div>
						<div class="form-group">
							<input type="checkbox" name="licenseRestriction" value="4"> Automatic Clutch up to 4500 KGs (Gross Vehicle Weight)
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<input type="checkbox" name="licenseRestriction" value="5"> Automatic Clutch above 4500 KGs (Gross Vehicle Weight)
						</div>
						<div class="form-group">
							<input type="checkbox" name="licenseRestriction" value="6"> Articulated Vehicle 1600 KGs and below (Gross Vehicle Weight)
						</div>
						<div class="form-group">
							<input type="checkbox" name="licenseRestriction" value="7"> Articulated Vehicle 1601 up to 4500 KGs (Gross Vehicle Weight)
						</div>
						<div class="form-group">
							<input type="checkbox" name="licenseRestriction" value="8"> Articulated Vehicle 4501 KGs and above (Gross Vehicle Weight)
						</div>
					</div>
				</div>
			</div>
